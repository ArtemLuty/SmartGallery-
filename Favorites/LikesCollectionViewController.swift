...
class LikesCollectionViewController: UICollectionViewController {
    ...
    private let enterSerchTermLabel:UILabel = {
        let label = UILabel()
        label.text = "You havent add a photos yet"
    ...
    private func setupEnterLabel() {
        collectionView.addSubview(enterSerchTermLabel)
        enterSerchTermLabel.centerXAnchor.constraint(equalTo: collectionView.centerXAnchor).isActive = true
        enterSerchTermLabel.topAnchor.constraint(equalTo: collectionView.topAnchor, constant: 50).isActive = true
    }
 ...
 private func setupNavigationBar() {
        ...
        override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
            enterSerchTermLabel.isHidden = photos.count != 0
            return photos.count
        }
    ...
    extension LikesCollectionViewController: UICollectionViewDelegateFlowLayout {
        ...
        func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
            ...
            return CGSize(width: width/3 - 1, height:
                width/3 - 1)
        }
    }
